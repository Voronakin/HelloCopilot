...
## Gemini CLI
Gemini CLI — бесплатный ИИ-помощник с открытым исходным кодом, который работает прямо в командной строке. Ассистент основан на модели Gemini 2.5 Pro и обладает всеми ее основными характеристиками, в том числе гигантским контекстным окном в 1 миллион токенов.

см. https://habr.com/ru/news/921842/
...
> Для того чтобы Claude Code взаимодействовал с IDE, необходимо вначале нажать на иконку плагина в правом верхнем углу,
> а затем в открывшемся консольном окне запустить скрипт sh ../start-claude-deepseek.sh.
